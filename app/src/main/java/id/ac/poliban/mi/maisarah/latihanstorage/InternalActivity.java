package id.ac.poliban.mi.maisarah.latihanstorage;
...
public class InternalActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buatFile = findViewById(R.id.btBuatFile);
        ubahFile = findViewById(R.id.btUbahFile);
        bacaFile = findViewById(R.id.btBacaFile);
        deleteFile = findViewById(R.id.btHapusFile);
        textBaca = findViewById(R.id.tvBaca);
